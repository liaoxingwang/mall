...
import com.mall.common.filter.LogoutFilter;
import com.mall.common.filter.OnlineSessionFilter;
import com.mall.common.redis.RedisUtils;
import com.mall.common.security.shiro.session.CacheSessionDAO;
import com.mall.common.security.shiro.session.SessionManager;
import com.mall.modules.sys.dao.OnlineSessionDAO;
import com.mall.modules.sys.dao.OnlineSessionFactory;
...
import com.mall.common.filter.SyncOnlineSessionFilter;
...
public class ShiroConfig {
    ...
    public SessionManager sessionManager(CacheSessionDAO dao) {
        ...
        sessionManager.setSessionIdCookie(new SimpleCookie("com.mall.session.id"));
