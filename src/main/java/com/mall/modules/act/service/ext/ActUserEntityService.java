...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.mall.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.mall.modules.sys.entity.User(null, userId)))){
