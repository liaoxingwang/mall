...
import com.mall.modules.oa.service.OaNotifyService;
...
import com.mall.modules.sys.security.SystemAuthorizingRealm.Principal;
...
//		try {
//			byte[] bytes = com.mall.common.utils.FileUtils.readFileToByteArray(
//					com.mall.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
